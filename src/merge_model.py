...
# 下载qwen模型
model_dir = snapshot_download('qwen/qwen2-7b-instruct', cache_dir='./model/', revision='master')
...
mode_path = './model/qwen/qwen2-7b-instruct/'
lora_path = './src/output/Qwen2_instruct_lora/checkpoint-1800' # 这里改称你的 lora 输出对应 checkpoint 地址
...
new_model_directory = "./model/merged_model_an"
...
os.system("cp ./model/qwen/qwen2-7b-instruct/tokenizer.json ./model/merged_model_an/")
